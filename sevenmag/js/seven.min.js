...
(function (e) {
    e.fn.superfish = function (t) {
        var n = e.fn.superfish, r = n.c, i = e(['<span class="', r.arrowClass, '"> <i class="fa-chevron-down"></i> </span>'].join("")), s = function () {
            var t = e(this), n = u(t);
...
(function (e) {
    e.fn.extend({
        photostream_widget: function (t) {
            ...
            var n = {user: "artbees", limit: 10, social_network: "instagram"};
            var t = e.extend(n, t);
            return this.each(function () {
                var n = t;
                var r = e(this);
                                ...
                                if (a != "") {
                                    ...
                                    e.getJSON(url, function (t) {
                                        e.each(t.data, function (t, n) {
                                            ...
                                            var u = e("<img/>").attr({src: i, alt: o});
                                            var a = e("<a/>").attr({href: s, target: "_blank", title: o});
                                            var f = e(a).append(u);
                                            var l = e("<li/>").append(f);
                                            e("ul", r).append(l)
                                        })
            ...
            init: function () {
                ...
                setup: function () {
                    ...
                    if (r.pagingCount > 1)for (var f = 0; f < r.pagingCount; f++) {
                        o = r.slides.eq(f);
                        s = r.vars.controlNav === "thumbnails" ? '<img src="../assets/js/' + o.attr("data-thumb") + '"/>' : "<a>" + n + "</a>";
...
!function (e) {
    ...
    }, e[a].defaults[o] = {open: !1, threshold: 50}, e[a].configuration[o] = {
